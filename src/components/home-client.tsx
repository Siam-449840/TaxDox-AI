...
function HomeContent() {
  ...
  // Only redirect if session becomes explicitly unauthenticated AFTER loading.
  // Since this component only renders when the server confirmed a session,
  // status will be 'loading' → 'authenticated'. If it ever becomes 'unauthenticated'
  // (e.g., session expired), redirect to signin.
  useEffect(() => {
